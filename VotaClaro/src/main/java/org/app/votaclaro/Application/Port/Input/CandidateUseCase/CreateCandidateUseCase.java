...
public interface CreateCandidateUseCase {
    ...
    CandidateResponse createCandidateWithoutPresidentialForm (CandidateRequestWithoutForm candidateRequestWithoutForm, MultipartFile urlImgPerson) throws Exception;
}
